...
export class EsAttributes {
  ...
  esAttributeAttParType:EsParams;
  
  esAttributeAttParStatus:EsParams;
  
  esAttributeCreatedBy:EsUsers;
  
  esAttributeUpdatedBy:EsUsers;
